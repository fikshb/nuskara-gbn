...
const en: Translations = {
  ...
  coverage: {
    ...
    headline: "Nationwide",
    headlineHighlight: "Port Network",
    description:
      "With headquarters in Jakarta and 21 port locations across 16 provinces, GBN provides seamless logistics coverage throughout Indonesia's key mining and industrial corridors.",
    stats: [
...
const id: Translations = {
  ...
  coverage: {
    ...
    headline: "Jaringan",
    headlineHighlight: "Pelabuhan Nasional",
    description:
      "Dengan kantor pusat di Jakarta dan 21 lokasi pelabuhan di 16 provinsi, GBN menyediakan cakupan logistik menyeluruh di seluruh koridor pertambangan dan industri utama Indonesia.",
    stats: [
